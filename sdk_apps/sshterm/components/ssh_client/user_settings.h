...
/* user_settings.h for sshterm on WHY 2025 Badge
...
/* Single threaded for BadgeVMS - wolfSSL multithreading not compatible */
#undef  SINGLE_THREADED
#define SINGLE_THREADED

/* Disable wolfSSL multithreading for BadgeVMS compatibility */
#define NO_WOLFSSL_MULTITHREADING
#define WOLFSSL_NO_MULTITHREAD

/* Use custom I/O with blocking read/write for BadgeVMS compatibility */
#define WOLFSSL_USER_IO                 /* Use custom I/O callbacks */
#define NO_WOLFSSL_SERVER               /* Client only */
#define NO_SESSION_CACHE                /* Reduce socket dependencies */
#define WOLFSSH_USER_IO                 /* Use custom wolfSSH I/O too */
#define WOLFSSH_TERM                /* Enable terminal support for wolfSSH */

/* Embedded system configuration */
#define WOLFSSL_SMALL_STACK
#define WC_NO_HARDEN
#define NO_WRITEV
#define NO_DEV_RANDOM               /* Don't try to access /dev/random */
#define NO_DEV_URANDOM              /* Don't try to access /dev/urandom */
#define BENCH_EMBEDDED

/* Disable POSIX features not available on badge */
#define NO_TERMIOS
/* NOTE: NO_FILESYSTEM disabled for wolfSSH - terminal functions need it */
#define NO_MAIN_DRIVER

/* Force inline compilation */
#define NO_INLINE

/* Custom random seed - implemented in badge_crypto_port.c */
/* Function declaration for custom RNG */
extern int badge_generate_seed(unsigned char* output, unsigned int sz);
#define CUSTOM_RAND_GENERATE_SEED badge_generate_seed

/* Required crypto algorithms for SSH */
#define HAVE_ECC
#define HAVE_RSA
#define HAVE_DH
#define HAVE_SHA256
...
/* Enable FFDHE groups for SSH key exchange */
...
/* Enable AES counter mode for SSH */
#define WOLFSSL_AES_DIRECT
#define WOLFSSL_AES_COUNTER

/* Enable AES-GCM for SSH */
#define HAVE_AESGCM

/* Enable AES-CBC for SSH */
#define HAVE_AES_CBC
...
/* Minimal debugging - disable verbose output */
...
/* Enable wolfSSH debugging - but not verbose */
